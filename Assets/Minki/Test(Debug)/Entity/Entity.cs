...
//    public float JumpPower { get; protected set; } // 점프 강도

//    public int AttackDamage { get; protected set; } // 기본 공격력
//    public float AttackCoolTime { get; protected set; } // 기본 공격 재사용 대기 시간

//    public int Skiil01Damage { get; protected set; } // 스킬1 공격력
//    public float Skill01CoolTime { get; protected set; } // 스킬1 재사용 대기 시간

//    public int Skill02Damage { get; protected set; } // 스킬2 공격력
//    public float Skill02CoolTime { get; protected set; } // 스킬2 재사용 대기 시간

//    public float AttackRange { get; protected set; } // 공격 범위
//    public float DetectRange { get; protected set; } // 플레이어 탐지 범위
...
//        playerOutfit.SetActive(true);
//    }

//    private void SetState(Monsters mon)
//    {
//        playerStateMachine.ChangeState(mon);
